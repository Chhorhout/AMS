...
namespace AMS.Api.Controller
{
    ...
    public class AssetsController : ControllerBase
    {
        ...
        public async Task<ActionResult<AssetResponseDto>> PostAsset(AssetCreateDto dto)
        {
            ...
            var locationResponseDto = _mapper.Map<LocationResponseDto>(asset.Location);
            var assetTypeResponseDto = _mapper.Map<AssetTypeResponseDto>(asset.AssetType);
            var invoiceResponseDto = _mapper.Map<InvoiceResponseDto>(asset.Invoice);
